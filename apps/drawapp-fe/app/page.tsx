        ...
        <nav className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-gray-900">Drawapp</span>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="bg-indigo-600 text-white px-6 py-2.5 rounded-lg hover:bg-indigo-700 transition-colors shadow-sm"
              >
                Get Started
              </button>
            </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-32">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-12 leading-relaxed max-w-3xl mx-auto">
              The professional whiteboarding platform that empowers teams to
              create, collaborate, and communicate with intuitive diagramming
              tools. Start creating without any barriers.
            </p>
            <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4 mb-12">
              <button
                onClick={pushToSignIn}
                className="w-full sm:w-auto bg-indigo-600 text-white px-8 py-4 rounded-lg hover:bg-indigo-700 transition-colors shadow-lg flex items-center justify-center group"
              >
                Start Drawing Free{" "}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Powerful features that help you bring your ideas to life, designed
              for professionals and teams who value efficiency and precision.
            </p>
          </div>
